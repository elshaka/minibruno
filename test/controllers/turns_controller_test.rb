...
class TurnsControllerTest < ActionController::TestCase
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post :create, turn: { description: @turn.description, end_time: @turn.end_time, start_time: @turn.start_time }
    end
  ...
  test "should update turn" do
    patch :update, id: @turn, turn: { description: @turn.description, end_time: @turn.end_time, start_time: @turn.start_time }
    assert_redirected_to turn_path(assigns(:turn))
  end
